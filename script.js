  ...
  },
  {
    ...
    lyrics: [
      ...
      },
      {
        ...
        kr: "너를 좋아했는데",
        words: [
          { text: "好きだった", tip: "好き: 좋아하다 + だった: ~이었다 (과거형)" }
        ]
      },
      {
        jp: "どうして終わってしまったの",
        ...
        kr: "왜 끝나버린 거야",
        words: [
          { text: "どうして", tip: "どうして: 왜, 어째서" },
          { text: "終わって", tip: "終わる: 끝나다 + て형" }
        ]
      },
      {
        jp: "もう一度だけ会いたい",
        ...
        kr: "딱 한 번만 더 만나고 싶어",
        words: [
          { text: "もう一度", tip: "もういちど: 한 번 더" },
          { text: "会いたい", tip: "会う: 만나다 + たい: ~하고 싶다" }
        ]
      },
      {
        jp: "笑顔が眩しかった",
        ...
        kr: "웃는 얼굴이 눈부셨어",
        words: [
          { text: "笑顔", tip: "えがお: 웃는 얼굴, 미소" },
          { text: "眩しかった", tip: "眩しい: 눈부시다 + かった: 과거형" }
        ]
      }
    ]
  },
    ...
    lyrics: [
      {
        ...
        kr: "열등감 따위는 걷어차 버려",
        words: [
          { text: "劣等感", tip: "れっとうかん: 열등감, 스스로를 낮게 여기는 감정" },
          { text: "蹴り飛ばせ", tip: "蹴り飛ばす: 걷어차다, 차서 날려버리다 (명령형)" }
        ]
      },
      {
        jp: "負けたって上等じゃないか",
        kana: "まけたってじょうとうじゃないか",
        kr: "졌다고 해서 어때, 그게 뭐가 나빠",
        words: [
          { text: "負けた", tip: "負ける: 지다, 패배하다" },
          { text: "上等", tip: "じょうとう: 상등, 훌륭함. 여기선 반어적으로 '어때서!' 의미" }
        ]
      },
      {
        jp: "ありのままの自分でいい",
        ...
        kr: "있는 그대로의 나여도 괜찮아",
        words: [
          { text: "ありのまま", tip: "있는 그대로, 꾸밈없이" },
          { text: "自分", tip: "じぶん: 자기 자신" }
        ]
      },
      {
        jp: "誰かに認められなくたって",
        ...
        kr: "누군가에게 인정받지 못해도",
        words: [
          { text: "認められ", tip: "認める: 인정하다 (수동형: 認められる = 인정받다)" }
        ]
      },
      {
        jp: "俺はここにいる",
        ...
        kr: "나는 여기에 있어",
        words: [
          { text: "俺", tip: "おれ: 나 (남성이 쓰는 강한 1인칭, 반항적·자기주장이 강한 뉘앙스)" }
        ]
      },
      {
        jp: "弱くていい、それでも立ち上がれ",
        kana: "よわくていい、それでもたちあがれ",
        kr: "약해도 괜찮아, 그래도 일어서",
        words: [
          { text: "弱くて", tip: "弱い: 약하다 + て형 (원인·이유)" },
          { text: "立ち上がれ", tip: "立ち上がる: 일어서다 (명령형 → 일어서라!)" }
        ]
      },
      {
        jp: "傷ついた分だけ強くなれる",
        kana: "きずついたぶんだけつよくなれる",
        kr: "상처받은 만큼 강해질 수 있어",
        words: [
          { text: "傷ついた", tip: "傷つく: 상처받다, 다치다" },
          { text: "分だけ", tip: "ぶんだけ: ~한 만큼, ~한 분량만큼" }
        ]
      },
      {
        jp: "最低でも最高を目指せ",
        ...
        kr: "최악이어도 최고를 향해 나아가",
        words: [
          { text: "最低", tip: "さいてい: 최저, 최악" },
          { text: "最高", tip: "さいこう: 최고" },
          { text: "目指せ", tip: "目指す: 목표로 하다, 향해 나아가다 (명령형)" }
        ]
      }
    ]
  }
